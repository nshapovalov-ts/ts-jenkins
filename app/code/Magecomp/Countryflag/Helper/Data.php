...
{
    CONST ENABLED = 'smspro/countryflag/enable';
    CONST DETECT_BY_IP = 'smspro/countryflag/detect_by_ip';
    CONST DETECT_BY_DEFAULT_COUNTRY = 'smspro/countryflag/defaultcountry';
