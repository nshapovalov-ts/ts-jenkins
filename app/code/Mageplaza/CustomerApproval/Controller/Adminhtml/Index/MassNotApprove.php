...
class MassNotApprove extends AbstractMassAction
{
    ...
    protected function massAction(AbstractCollection $collection)
    {
        ...
        foreach ($collection->getAllIds() as $customerId) {
            ...
            $vid = $this->eyeImagineSyncHelper->getVidByCustomerEmail($customer->getEmail());
            if($vid){
               $this->eyeImagineSyncHelper->updatePropertyByVid($vid,'eyemagine_is_approved','Not Approved');
            }
            $customersUpdated++;
        }
