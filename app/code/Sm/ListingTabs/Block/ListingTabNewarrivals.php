...
class ListingTabNewarrivals extends \Magento\Catalog\Block\Product\AbstractProduct
{
	...
	public function _getProductsBasic($catids = null,  $tab = false)
	{
	   ...
	   $todayDate = date("Y-m-d h:i:s"); // current date
		...
		$collection->addFieldToFilter('news_from_date', ['lteq' => $todayDate])
        ->addFieldToFilter('news_to_date', ['gteq' => $todayDate]);
