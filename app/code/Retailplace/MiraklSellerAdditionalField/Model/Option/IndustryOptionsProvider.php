...
class IndustryOptionsProvider extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource
{
    /**
    ...
    public function getAllOptions()
    {
        if ($this->_options === null) {
            ...
            $industryExclusionsCollection->getSelect()->where("`status` IS NULL OR `status` != '2'")->order('label ASC');
