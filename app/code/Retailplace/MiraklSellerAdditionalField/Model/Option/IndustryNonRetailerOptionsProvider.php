...
class IndustryNonRetailerOptionsProvider extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource
{
    /**
    ...
    public function getAllOptions()
    {
        ...
        if ($this->_options === null) {
            ...
            $industryExclusionsCollection->addFieldToFilter('visible_for',['finset'=>[2]]);
