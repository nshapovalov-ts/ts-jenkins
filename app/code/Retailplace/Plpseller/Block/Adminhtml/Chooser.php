<?php
namespace Retailplace\Plpseller\Block\Adminhtml;
...
class Chooser extends Multiselect
{
    ...
    public function getElementHtml()
    {
        ...
        $html .= '<input name="category_id" data-bind="value: value" style="display: none"/>';
                    ...
                    "Magento_Ui/js/core/app": {
                        "components": {
                            "topbannerCategory": {
                                ...
                                "children": {
                                    "select_category": {
                                        "component": "Retailplace_Plpseller/js/components/new-category",
                                        "config": {
                                            "filterOptions": true,
                                            "disableLabel": true,
                                            "chipsEnabled": true,
