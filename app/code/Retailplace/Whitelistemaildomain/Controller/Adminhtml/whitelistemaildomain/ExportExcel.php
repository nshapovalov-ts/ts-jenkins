...
class ExportExcel extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $fileName = 'whitelistemaildomain.xml';

        $exportBlock = $this->_view->getLayout()->createBlock('Retailplace\Whitelistemaildomain\Block\Adminhtml\Whitelistemaildomain\Grid');
