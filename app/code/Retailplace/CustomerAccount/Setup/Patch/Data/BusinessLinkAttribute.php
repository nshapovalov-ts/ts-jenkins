...
class BusinessLinkAttribute implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $customerSetup->addAttribute(Customer::ENTITY, 'business_link', [
            'input' => 'text',
            'type' => 'varchar',
            'label' => 'Business Link',
            'required' => false,
        ...
        $attribute = $customerSetup->getEavConfig()->getAttribute(Customer::ENTITY, 'business_link')
            ->addData([
