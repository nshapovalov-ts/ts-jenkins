...
class IncompleteApplicationAttribute implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $customerSetup->addAttribute(Customer::ENTITY, 'incomplete_application', [
            'type' => 'int',
            'label' => 'Incomplete Application',
            'input' => 'select',
            'source' => IncompleteApplicationStatus::class,
            'required' => false,
            'visible' => true,
            'default' => 1,
            'user_defined' => true,
        ...
        $attribute = $customerSetup->getEavConfig()->getAttribute(Customer::ENTITY, 'incomplete_application')
            ->addData([
