 ...
 * Class AghaMember
 */
class AghaMember extends AbstractUpdater implements UpdaterInterface
{
    /** @var string */
    protected $attributeCode = 'agha_member';

    /** @var \Mirakl\Core\Model\ResourceModel\Shop\CollectionFactory */
    private $shopCollectionFactory;

    /**
     * AghaMember Constructor
     *
    ...
    private function getShopIds(): array
    {
        ...
        $shopCollection->addFieldToFilter('agha_seller', ['eq' => 1]);
