 ...
 * Class FreeShipping
 */
class FreeShipping extends AbstractUpdater implements UpdaterInterface
{
    /** @var string */
    protected $attributeCode = 'free_shipping';
    ...
    private function getShopIds(): array
    {
        ...
        $shopCollection->addFieldToFilter('free_shipping', ['eq' => 1]);
