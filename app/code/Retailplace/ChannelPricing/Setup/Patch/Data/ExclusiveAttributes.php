...
/**
 * Class ExclusiveAttributes
 */
class ExclusiveAttributes implements DataPatchInterface
{
    /** @var array */
    public const ATTRIBUTES_DATA = [
        ProductAttributesInterface::AU_POST_EXCLUSIVE => ['label' => 'Exclusive to AU Post'],
        ProductAttributesInterface::NLNA_EXCLUSIVE => ['label' => 'Exclusive to NLNA']
    ];
