...
namespace Retailplace\ChannelPricing\Plugin\ResourceModel\Product\Indexer\Price;
...
class Configurable implements DimensionalIndexerInterface
{
     ...
     *
     * @param PriceConfigurable $subject
    ...
    public function aroundExecuteByDimensions(
        PriceConfigurable $subject,
        Closure $proceed,
        array $dimensions,
        Traversable $entityIds
    ) {
        $this->executeByDimensions($dimensions, $entityIds);
    }
