<?php
namespace Mirakl\MMP\FrontOperator\Request\Payment\Transaction;
...
use Mirakl\MMP\FrontOperator\Domain\Collection\Payment\Transaction\TransactionLineCollection;
