...
abstract class AbstractCreateShop extends MiraklObject
{
     ...
     * @return \DateTime
     */
    public function getImmunizedUntil()
    {
        return $this->getData('immunity_date');
    }

    /**
     * @param  \DateTime    $immunizedUntil
     * @return $this
     */
    public function setImmunizedUntil($immunizedUntil)
    {
        return $this->setData('immunity_date', $immunizedUntil);
    }
