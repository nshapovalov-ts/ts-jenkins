<?php
namespace Mirakl\MMP\FrontOperator\Domain\Payment\Transaction;
 ...
 * @method  TransactionShop     getShop()
 * @method  $this               setShop(TransactionShop $shop);
...
class TransactionLine extends MiraklObject
{
    ...
    protected static $dataTypes = [
        ...
        'shop' => [TransactionShop::class, 'create'],
    ];
}