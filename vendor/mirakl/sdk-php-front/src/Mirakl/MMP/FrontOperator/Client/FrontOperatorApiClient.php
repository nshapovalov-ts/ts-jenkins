...
use Mirakl\MMP\Common\Domain\Collection\Evaluation\ShopEvaluationCollection;
...
use Mirakl\MMP\FrontOperator\Request\Payment\Transaction\TransactionLineRequest;
 ...
 * @method  void                            disputeIncident(DisputeIncidentRequest $request);
 ...
 * @method  ShopEvaluationCollection        getShopEvaluations(GetShopEvaluationsRequest $request)
