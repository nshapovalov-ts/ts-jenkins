...
/**
 * @method FileWrapper                  exportCsvDeletedProducts(GetDeletedProductsCsvRequest $request)
 * @method ProductDeletedCollection     exportDeletedProducts(GetDeletedProductsRequest $request)
