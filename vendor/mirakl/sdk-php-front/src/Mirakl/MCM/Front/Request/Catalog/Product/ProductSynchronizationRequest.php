...
use Mirakl\MCM\FrontOperator\Request\Catalog\Product\AbstractProductSynchronizationRequest;
 ...
 *   -> Accept or reject products: in this case add an acceptance entry with the status ACCEPTED or REJECTED.
 ...
 * </code>
 */
class ProductSynchronizationRequest extends AbstractProductSynchronizationRequest
{
    /**
     * @var array
     */
